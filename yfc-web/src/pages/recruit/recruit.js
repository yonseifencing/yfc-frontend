...
export default function RecruitPage() {
  return (
    <div className="recruit">
      <div className="recruit_wide">
        <div className="recruit_image">
        ...
        <div className="note">
          <h3>참고사항</h3>
          <h4>
            - 신입생의 경우 기본기를 다지기 위해 필수적으로 4주간 한 주에 2회
            이상 운동에 참여해야 합니다. (이후 미달자의 경우 이번 학기 활동이
            불가능합니다.)
          </h4>
      ...
      <div className="recruit_small">
        ...
        <div className="recruit_content_small">
          ...
          <div className="notes">
            ...
            <p>- 4주 훈련 기간: 3월 18일 ~ 4월 13일</p>
            <p>- 이번 학기 운동 장소는 "스포츠 과학관 다목적실3" 입니다.</p>
            <p>
              - 신입생 4주 훈련을 이수하면 정규 부원이 되어 정규 운동에 참여하게
              됩니다.
            </p>
            <p>
              - 회비는 입회비 1만원, 활동비 5만원입니다. 추가로 운동을 위한 개인
              바디와이어 장비 구매가 필수입니다. (이후 공동구매를 진행하여
              15,000 ~ 49,000원 제품 중 본인이 선택)
            </p>
          </div>
        </div>
      </div>
